...
def db_seed():
    ...
    test_user = User(first_name="William",
                     last_name="Harshal",
                     email="william.harshal@gmail.com",
                     password="password")
...
@app.route("/")
def hello_world():
    return "Hello from flask with APO"
...
@app.route('/url_variable/<string:name>/<int:id>')
def url_variables(name: str, id: int):
    return jsonify(name=name, id=id)
...
def login():
    ...
    if test:
        ...
        return jsonify(message='Login not working'), 401
...
def get_planet_details(planet_id: int):
    ...
    if planet:
        ...
        return jsonify(message=f"Planet ID {planet_id} not fount"), 404
...
def add_planet():
    ...
    if test:
        return jsonify(message=f"Planet already exists with {planet_name} name"), 409
    else:
...
def update_planet():
    ...
    if planet:
        ...
        return jsonify(message=f"No planet found with ID {planet_id}"), 404
